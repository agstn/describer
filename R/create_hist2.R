...
#' create_hist2(adsl$AGE)
#' create_hist2(adsl$SITEID)
#'
#' @export
create_hist2 <- function(x, counts, values) {
  UseMethod("create_hist2", x)
}

#' @export
create_hist2.character <- function(x, counts, values){
...
#' @export
create_hist2.factor <- create_hist2.character

#' @export
create_hist2.numeric <- function(x, counts, values){
...
#' @export
create_hist2.Date <- function(x, counts, values){
...
#' @export
create_hist2.POSIXct  <- create_hist2.Date

#' @export
create_hist2.POSIXlt  <- create_hist2.Date


#' @export
create_hist2.timePOSIXt <- function(x, counts, values){
